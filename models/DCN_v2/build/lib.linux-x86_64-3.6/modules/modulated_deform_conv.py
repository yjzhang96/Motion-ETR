...
class ModulatedDeformConvPack(ModulatedDeformConv):
    ...
    def __init__(self, in_channels, out_channels,
                 kernel_size, stride, padding, offset=None,
                 dilation=1, groups=1, deformable_groups=1, im2col_step=64, bias=False, lr_mult=0.1):
    ...
    def forward(self, input):
        ...
        if self.offset is not None:
            offset_out = self.offset
        # offset_out = self.conv_offset_mask(ft_cat)
